...
function agregarNuevaTarea() {
  // limpiar notificaion de retardo
...
// asicnrono
let btnAgregarRetardo = document.getElementById("btnAgregarRetardo");
let notificacion = document.getElementById("notificacion");

btnAgregarRetardo.addEventListener("click", function () {
  let texto = txtDescripcion.value.trim();

  if (texto === "") {
    return;
  }

  agregarTareaConRetardo(texto);
  txtDescripcion.value = "";
});


function agregarTareaConRetardo(texto) {
  notificacion.style.display = "block";
  notificacion.className = "alert alert-warning";
  notificacion.textContent = "Agregando tarea, por favor espere...";
  ...
  setTimeout(function () {
    ...
    notificacion.textContent = "Tarea agregada con retardo";
